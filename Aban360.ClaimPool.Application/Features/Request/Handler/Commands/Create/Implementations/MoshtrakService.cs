    ...
    public static class MoshtrakService
    {
        public static MoshtrakServiceDto GetServicesSelected(ICollection<int> servicesSelected)
        {
            return new MoshtrakServiceDto()//todo: s1,s2?
            {
                ...
                s11 = servicesSelected.Contains((int)CompanyServiceEnum.TafkikArseAb) ? 1 : 0,//تفکیک عرصه اب
                s12 = servicesSelected.Contains((int)CompanyServiceEnum.IsTafkikArseFazelab) ? 1 : 0,//تفکیک عرصه فاضلاب
                ...
                s21 = servicesSelected.Contains((int)CompanyServiceEnum.KhatEnteqhalAb) ? 1 : 0,//خط انتقال اب
                s22 = servicesSelected.Contains((int)CompanyServiceEnum.KhatEnteqhalFazelab) ? 1 : 0,//خط انتقال فاضلاب
                s23 = servicesSelected.Contains((int)CompanyServiceEnum.SahmManbaAb) ? 1 : 0,//سهم منبع اب
                ...
                s42 = servicesSelected.Contains((int)CompanyServiceEnum.LooleGozariAb) ? 1 : 0,//لوله گذاری آب
                s43 = servicesSelected.Contains((int)CompanyServiceEnum.LooleGozareAbFazelab) ? 1 : 0,//لوله گذاری فاضلاب
