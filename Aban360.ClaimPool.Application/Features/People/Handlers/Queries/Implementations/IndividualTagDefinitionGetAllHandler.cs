...
{
    internal sealed class IndividualTagDefinitionGetAllHandler : IIndividualTagDefinitionGetAllHandler
    {
        ...
        {
            ICollection<IndividualTagDefinition> individualTagDefinition = await _queryService.Get();
