...
namespace Aban360.ClaimPool.Application.Features.People.Handlers.Queries.Implementations
{
    public class IndividualTagGetSingleHandler : IIndividualTagGetSingleHandler
    {
        ...
        public async Task<ICollection<IndividualTagGetDto>> Handle(string nationalCode, CancellationToken cancellationToken)
        {
            var IndividualTag = await _IndividualTagQueryService.Get(nationalCode);
