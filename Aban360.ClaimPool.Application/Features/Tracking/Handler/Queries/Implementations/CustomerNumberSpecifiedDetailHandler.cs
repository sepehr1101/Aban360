...
{
    internal sealed class CustomerNumberSpecifiedDetailHandler : ICustomerNumberSpecifiedDetailHandler
    {
        ...
        public CustomerNumberSpecifiedDetailHandler(
        ...
        public async Task<CustomerNumberSpecifiedOutputDto> Handle(TrackingDetailGetDto inputDto, CancellationToken cancellationToken)
        {
            await Validation(inputDto, cancellationToken);
            CustomerNumberSpecifiedOutputDto data = await _trackingDetailQueryService.GetCustomerNumberSpecified(inputDto);
            return data;
        }
