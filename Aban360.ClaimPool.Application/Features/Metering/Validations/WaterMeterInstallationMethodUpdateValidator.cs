...
{
    public class WaterMeterInstallationMethodUpdateValidator : BaseValidator<WaterMeterInstallationMethodUpdateDto>
    {
        public WaterMeterInstallationMethodUpdateValidator()
        {
            RuleFor(f => f.Id)
