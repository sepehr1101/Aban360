...
{
    internal sealed class MeterDiameterGetAllHandler : IMeterDiameterGetAllHandler
    {
        ...
        {
            ICollection<MeterDiameter> meterDiameter = await _meterDiameterQueryService.Get();
