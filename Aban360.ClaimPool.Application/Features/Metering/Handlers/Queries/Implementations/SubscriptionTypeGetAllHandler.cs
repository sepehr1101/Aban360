...
{
    internal sealed class SubscriptionTypeGetAllHandler : ISubscriptionTypeGetAllHandler
    {
        ...
        {
            ICollection<SubscriptionType> subscriptionType = await _subscriptionTypeQueryService.Get();
