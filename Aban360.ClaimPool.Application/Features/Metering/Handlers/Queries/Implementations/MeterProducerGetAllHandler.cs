...
{
    internal sealed class MeterProducerGetAllHandler : IMeterProducerGetAllHandler
    {
        ...
        {
            ICollection<MeterProducer> meterProducer = await _meterProducerQueryService.Get();
