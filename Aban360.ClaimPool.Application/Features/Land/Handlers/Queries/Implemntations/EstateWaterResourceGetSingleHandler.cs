...
{
    public class EstateWaterResourceGetSingleHandler : IEstateWaterResourceGetSingleHandler
    {
        ...
        {
            var estateWaterResource = await _estateWaterResourceQueryService.Get(id);
