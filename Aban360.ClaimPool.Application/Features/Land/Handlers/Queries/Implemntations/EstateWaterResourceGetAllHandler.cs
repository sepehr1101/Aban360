...
{
    internal sealed class EstateWaterResourceGetAllHandler : IEstateWaterResourceGetAllHandler
    {
        ...
        {
            ICollection<EstateWaterResource> estateWaterResource = await _estateWaterResourceQueryService.Get();
