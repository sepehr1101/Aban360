...
namespace Aban360.OldCalcPool.Application.Features.WaterReturn.Handlers.Commands.Implementations
{
    internal sealed class ReturnBillSetConfirmHandler : AbstractBaseConnection, IReturnBillSetConfirmHandler
    {
        ...
        private RepairCreateDto GetRepairCreateDto(RepairGetDto atlasRepair)
        {
            return new RepairCreateDto()
            {
                Town = atlasRepair.Town,
                Radif = atlasRepair.Radif,
                Eshtrak = atlasRepair.Eshtrak,
                Barge = atlasRepair.Barge,
                PriNo = atlasRepair.PriNo,
                TodayNo = atlasRepair.TodayNo,
                PriDate = atlasRepair.PriDate,
                TodayDate = atlasRepair.TodayDate,
                AbonFas = atlasRepair.AbonFas,
                FasBaha = atlasRepair.FasBaha,
                AbBaha = atlasRepair.AbBaha,
                Ztadil = atlasRepair.Ztadil,
                ...
                AbonAb = atlasRepair.AbonAb,
                Pard = atlasRepair.Pard,
                Jam = atlasRepair.Jam,
                CodVas = atlasRepair.CodVas,
                Ghabs = atlasRepair.Ghabs,
                Del = atlasRepair.Del,
                Type = atlasRepair.Type,
                CodEnshab = atlasRepair.CodEnshab,
                Enshab = atlasRepair.Enshab,
                Elat = atlasRepair.Elat,
                Serial = atlasRepair.Serial,
                Ser = atlasRepair.Ser,
                ZaribFasl = atlasRepair.ZaribFasl,
                Ab10 = atlasRepair.Ab10,
                Ab20 = atlasRepair.Ab20,
                TedadVahd = atlasRepair.TedadVahd,
                TedKhane = atlasRepair.TedKhane,
                TedadMas = atlasRepair.TedadMas,
                TedadTej = atlasRepair.TedadTej,
                NoeVa = atlasRepair.NoeVa,
                Jarime = atlasRepair.Jarime,
                Masjar = atlasRepair.Masjar,
                Sabt = atlasRepair.Sabt,
                Rate = atlasRepair.Rate,
                Operator = atlasRepair.Operator,
                Mamor = atlasRepair.Mamor,
                TavizDate = atlasRepair.TavizDate,
                ZaribCntr = atlasRepair.ZaribCntr,
                Zabresani = atlasRepair.Zabresani,
                ZaribD = atlasRepair.ZaribD,
                Tafavot = atlasRepair.Tafavot,
                MasHadar = atlasRepair.MasHadar,
                AbHadar = atlasRepair.AbHadar,
                RangeMas = atlasRepair.RangeMas,
                TafBack = atlasRepair.TafBack,
                TedGhabs = atlasRepair.TedGhabs,
                TabAbnA = atlasRepair.TabAbnA,
                TabAbnF = atlasRepair.TabAbnF,
                TabsFa = atlasRepair.TabsFa,
                Bodjeh = atlasRepair.Bodjeh,
                Group1 = atlasRepair.Group1,
                Faz = atlasRepair.Faz,
                ChkKarbari = atlasRepair.ChkKarbari,
                C200 = atlasRepair.C200,
                TmpPriDate = atlasRepair.TmpPriDate,
                TmpTodayDate = atlasRepair.TmpTodayDate,
                TmpMohlat = atlasRepair.TmpMohlat,
                TmpTavizDate = atlasRepair.TmpTavizDate,
                TmpDateBed = atlasRepair.TmpDateBed,
                EdarehK = atlasRepair.EdarehK,
                Lavazem = atlasRepair.Lavazem,
                DateSbt = atlasRepair.DateSbt,
                Avarez = atlasRepair.Avarez,
            };
        }
