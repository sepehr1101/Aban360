...
namespace Aban360.OldCalcPool.Application.Features.Processing.Handlers.Commands.Implementations
{
    internal sealed class OldTariffEngine : BaseExpressionCalculator, IOldTariffEngine
    {
        ...
        private BaseOldTariffEngineOutputDto CalculateWaterBill(NerkhGetDto nerkh, NerkhGetDto nerkh1403, AbAzadFormulaDto abAzad, ZaribGetDto zarib, CustomerInfoOutputDto customerInfo, MeterInfoOutputDto meterInfo, string currentDateJalali, ConsumptionInfo consumptionInfo, int _olgoo, [Optional] int? c, [Optional] IEnumerable<int>? tagIds)
        {
            ...
            TariffItemResult fazelab = _fazelabCalculator.Calculate(nerkh, monthlyConsumption, olgoo, c, zarib,  consumptionPartialInfo.StartDateJalali, consumptionPartialInfo.EndDateJalali, consumptionPartialInfo.Duration, customerInfo, abBahaResult.Summation, currentDateJalali, false, isVillageCalculation, consumptionPartialInfo, abBahaResult, out double multiplierFazelab);
            ...
            TariffItemResult fazelabDiscount = _fazelabCalculator.CalculateDiscount(nerkh, fazelab, abBahaDiscount.Summation, fazelab.Summation, customerInfo, consumptionPartialInfo);
