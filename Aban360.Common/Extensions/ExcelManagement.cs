    ...
    public static class ExcelManagement
    {
        ...
        private static Dictionary<string, string> GetPersianProperty()
        {
            return new Dictionary<string, string>()
            {
                    ...
                    {"Consumption", "مصرف"},
                    {"SewageConsumption", "مصرف فاضلاب"},
                    {"SumSewageConsumption", "مجموع مصرف فاضلاب"},
                    ...
                    {"InstallationDateJalali", "تاریخ نصب "},
                    ...
                    {"CurretnDateJalali", "تاریخ فعلی"},
                    {"CurrentCounterStateCode", "وضعیت قرائت فعلی"},
                    {"AgentCode", "کد مامور"},
                    {"PreviousRegisterDateJalali", "تاریخ قبض قبلی"},
                    {"", ""},
                    {"GroupKey", "دسته"},
                    ...
                    { "Barge","شماره برگه"},
                    { "AbBaha", "آب بها"},
                    { "FazelabBaha", "کارمزد دفع فاضلاب"},
                    { "AbonmanAb", "آبونمان آب"},
                    { "AbonmanFazelab", "آبونمان فاضلاب"},
                    { "Maliat", "عوارض شهرداری"},
                    { "Tabsare2", "تبصره 2"},
                    { "Tabsare2_3", "تبصره 2 و 3 قدیم (قابل جمع با آب بها)"},
                    { "Jarime", "جریمه"},
                    { "Abresani", "آبرسانی"},
                    { "JavaniJamiat", "ضریب D/ جوانی جمعیت"},
                    { "FaslGarm", "فصل گرم سال "},
                    { "ZaribTadil", "ضریب تعدیل"},
                    { "Tabsare3Ab", "تبصره3 آب"},
                    { "Tabsare3Fazelab", "تبصره3 فاضلاب"},
                    { "TabsareAbonmanFazelab", "تبصره آبونمان فاضلاب"},
                    ...
                    { "WaterDebt", "بدهی"},
                    { "CommandDateTime", "تاریخ ایجاد"},
                    { "CommandDateTimeJalali", "تاریخ ایجاد"},
                    { "CommandBy", "ایجاد توسط"},
                    { "CommandCauseId", "کد علت دستوز"},
                    { "CommandCauseTitle", "علت دستور"},
                    { "ResultDateTime", "تاریخ ثبت نتیجه"},
                    { "ResultDateTimeJalali", "تاریخ ثبت نتیجه"},
                    { "ResultByResultId", "ثبت نتیجه توسط"},
                    { "ResultId", "کد نتیجه"},
                    { "CompanyId", "کد شرکت"},
                    { "PersonnelId", "شناسه مامور وصول"},
                    { "PersonnelName", "نام مامور وصول"},
                    { "JudicialNoticeId", "کد پیگیری قوع قضاییه"},
                    { "TypeId", "نوع"},
