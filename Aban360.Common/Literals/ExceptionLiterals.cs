namespace Aban360.Common.Literals
{
    public static class ExceptionLiterals
    {
        ...
        public static string NotAccessZone { get { return "به این ناحیه دسترسی ندارید."; } }
        ...
        public static string InvalidLessThanCommandDate => "تاریخ وارد شده نباید از تاریخ صدور دستور کوچکتر باشد.";
        public static string InvalidDebtAmountLessThanZero => "مبلغ بدهی آب‌بها کمتر از صفر است.";
        public static string InvalidDeletionState => "نامعتبر! کنتور جمع‌آوری شده";
        public static string DmsInfoNotFound => "اطلاعات بایگانی الکترونیک یافت نشد";
        ...
        public static string InvalidBankDateBefor60DaysAgo => "تاریخ بانک نباید کمتر از 60 روز گذشته باشد.";
        ...
        public static string InvalidServiceLinkReturnRemoveLessThan7Days => "قبض برگشتی جاری، بیش از 7 روز گذشته صادر شده.";
