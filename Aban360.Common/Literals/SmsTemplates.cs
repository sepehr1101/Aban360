    ...
    public static class SmsTemplates
    {
        ...
        public static string ServiceLinkConnected
        {
            get
            {
                return @"آبفا منطقه {0}{5}" +
                        @"مشترک گرامی آقا/خانم {1} به شناسه قبض{2}{5}" +
                        @"انشعاب شما در تاریخ {3} توسط مامور قطع‌ووصل آقای {4} وصل گردید.";
            }
        }
...
ش پ: {8}";
        ...
        public static string ClosedBill
        {
            get
            {
                return @"آبفا {0}{2}
                        مشترک گرامی به شناسه قبض{1}{2}
                        لطفا ظرف 24 ساعت آینده شماره کنتور خود را با استفاده از کلید 5 سرشماره 1522 اعمال نمایید.";
