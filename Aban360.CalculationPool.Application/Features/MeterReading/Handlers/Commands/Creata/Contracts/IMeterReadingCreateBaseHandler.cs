...
namespace Aban360.CalculationPool.Application.Features.MeterReading.Handlers.Commands.Creata.Contracts
{
    public interface IMeterReadingCreateBaseHandler
    {
        ...
        MeterFlowCreateDto GetMeterFlowCreateDto(MeterFlowStepEnum step, int firstFlowId, string fileName, int zoneId, string fromReadingNumber, string toReadingNumber, int primaryCount, Guid userId, string description);
