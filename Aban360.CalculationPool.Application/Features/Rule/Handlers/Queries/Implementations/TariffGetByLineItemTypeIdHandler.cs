...
{
    internal sealed class TariffGetByLineItemTypeIdHandler : ITariffGetByLineItemTypeIdHandler
    {
        ...
        {
            ICollection<Tariff> tariff = await _tariffQueryService.GetByLineItemType(id);
