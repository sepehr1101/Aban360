...
namespace Aban360.CalculationPool.Application.Features.TestTariff.Handlers.Implementations
{
    internal sealed class TariffTestSingleCustomerHandler : ITariffTestSingleCustomerHandler
    {
        ...
        public TariffTestSingleCustomerHandler(
            IBaseIntervalTariffEngine baseIntervalTariffEngine)
        {
            _baseIntervalTariffEngine = baseIntervalTariffEngine;
            _baseIntervalTariffEngine.NotNull(nameof(baseIntervalTariffEngine));
        }
        public async Task<IntervalCalculationResultWrapper> Handle(TariffTestInput tariffTestInput, CancellationToken cancellationToken)
        {
