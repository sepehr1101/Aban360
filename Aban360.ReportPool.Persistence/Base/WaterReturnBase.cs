...
namespace Aban360.ReportPool.Persistence.Base
{
    internal abstract class WaterReturnBase : AbstractBaseConnection
    {
        ...
        public WaterReturnBase(IConfiguration configuration)
                : base(configuration)
        {
        }
        ...
        internal string GetDetailQuery(bool hasZone, bool hasUsage, bool hasBranchType)
        {
            ...
            return @$"use CustomerWarehouse
					Select
                        ...
                        b.ReturnCauseId ReturnCauseId,
                        b.ReturnCauseTitle  ReturnCauseTitle,
						b.Duration,
						--b.SumItems,
					...
					Where 
                        ...
                        b.ReturnCauseId IN @ReturnCauseIds AND
						b.TypeCode IN @typeCodes
						{usageQuery}
						{zoneQuery}
                        {branchTypeQuery}";
        }
        internal string GetSummaryQuery(bool isUsageGroup, bool hasZone, bool hasUsage, bool hasBranchType, WaterReturnSummaryEnum enumState)
        {
        ...
        internal (string, string, string) GetEnumQuery(WaterReturnSummaryEnum enumState, bool isUsageGroup)
        {
            return enumState switch
            {
                WaterReturnSummaryEnum.AverageConsumption => ("Ceiling(ConsumptionAverage)", "Ceiling(ConsumptionAverage)", "Ceiling(ConsumptionAverage)"),
                WaterReturnSummaryEnum.RegisterDay => ("RegisterDay", "RegisterDay", "RegisterDay"),
                WaterReturnSummaryEnum.Zone => ("ZoneTitle", "ZoneTitle", "ZoneId"),
                WaterReturnSummaryEnum.Usage => isUsageGroup ? ("UsageGroup2Title", "UsageGroup2Title", "UsageGroup2Title") : ("UsageTitle", "UsageTitle", "UsageId"),
                WaterReturnSummaryEnum.Region => ("RegionTitle", "RegionTitle", "RegionTitle"),
                WaterReturnSummaryEnum.UsageAndZone => isUsageGroup ? ("ZoneTitle, UsageGroup2Title", "(ZoneTitle CollaTe SQL_Latin1_General_CP1_CI_AS+' - '+ UsageGroup2Title)", "ZoneTitle, UsageGroup2Title") : ("ZoneTitle, UsageTitle", "(ZoneTitle Collate SQL_Latin1_General_CP1_CI_AS+' - '+UsageTitle)", "ZoneId, UsageId"),
                WaterReturnSummaryEnum.ReturnCause => ("ReturnCauseTitle", "ReturnCauseTitle", "ReturnCauseTitle"),
