...
{
    internal sealed class UseStateReportSummaryByUsageQueryService : AbstractBaseConnection, IUseStateReportSummaryByUsageQueryService
    {
        public UseStateReportSummaryByUsageQueryService(IConfiguration configuration)
            : base(configuration) { }

        public async Task<ReportOutput<UseStateReportHeaderSummaryOutputDto, UseStateReportSummaryByUsageDataOutputDto>> Get(UseStateReportInputDto input)
        {
            string useStateReportQueryString = GetUseStateReportQuery();
            var @params = new
            {
            ...
            IEnumerable<UseStateReportSummaryByUsageDataOutputDto> data = await _sqlReportConnection.QueryAsync<UseStateReportSummaryByUsageDataOutputDto>(useStateReportQueryString, @params);
