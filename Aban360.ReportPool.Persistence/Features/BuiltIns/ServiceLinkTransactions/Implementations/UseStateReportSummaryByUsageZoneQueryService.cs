...
{
    internal sealed class UseStateReportSummaryByUsageZoneQueryService : UseStateBase, IUseStateReportSummaryByUsageZoneQueryService
    {
        public UseStateReportSummaryByUsageZoneQueryService(IConfiguration configuration)
            : base(configuration)
        {
        }
        ...
        public async Task<ReportOutput<UseStateReportHeaderSummaryOutputDto, UseStateReportSummaryDataOutputDto>> Get(UseStateReportInputDto input)
        {
            ...
            string query = GetGroupedUsageZoneQuery(input.IsWater);
        ...
        private async Task<string> GetReportTitle(short useStateId)
        {
            ...
            return ReportLiterals.Report + " " + ReportLiterals.ByUsage + "-" + ReportLiterals.ZoneTitle + useStateTitle;
        }
