...
{
    internal sealed class MeterReplacementLifeSummaryQueryService : AbstractBaseConnection, IMeterReplacementLifeSummaryQueryService
    {
        public MeterReplacementLifeSummaryQueryService(IConfiguration configuration)
            : base(configuration)
        {
        }
        ...
        {
            string reportTitle = ReportLiterals.MeterReplacementLifeSummary;
