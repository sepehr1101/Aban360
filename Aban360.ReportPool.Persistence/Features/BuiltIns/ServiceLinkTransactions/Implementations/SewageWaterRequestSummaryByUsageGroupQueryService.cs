...
{
    internal sealed class SewageWaterRequestSummaryByUsageGroupQueryService : RequestOrInstallBase, ISewageWaterRequestSummaryByUsageGroupQueryService
    {
        public SewageWaterRequestSummaryByUsageGroupQueryService(IConfiguration configuration)
            : base(configuration)
        {
        }

        public async Task<ReportOutput<SewageWaterRequestHeaderOutputDto, SewageWaterRequestSummaryDataOutputDto>> Get(SewageWaterRequestByUsageGroupInputDto input)
        {
            string UsageTitle = nameof(UsageTitle);
            string query = GetGroupedByUsageGroupQuery(input.IsWater, InstallOrRequestOrInstallDepartmentEnum.Request);
            string reportTitle = input.IsWater ? ReportLiterals.WaterRequestSummary + ReportLiterals.ByUsageGroup : ReportLiterals.SewageRequestSummary + ReportLiterals.ByUsageGroup;
