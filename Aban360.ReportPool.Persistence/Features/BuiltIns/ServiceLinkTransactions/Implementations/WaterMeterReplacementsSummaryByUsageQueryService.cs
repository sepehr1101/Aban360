...
{
    internal sealed class WaterMeterReplacementsSummaryByUsageQueryService : AbstractBaseConnection, IWaterMeterReplacementsSummaryByUsageQueryService
    {
        ...
        public async Task<ReportOutput<WaterMeterReplacementsHeaderOutputDto, WaterMeterReplacementsSummaryByUsageDataOutputDto>> Get(WaterMeterReplacementsInputDto input)
        {
            ...
            IEnumerable<WaterMeterReplacementsSummaryByUsageDataOutputDto> waterMeterReplacementsData = await _sqlReportConnection.QueryAsync<WaterMeterReplacementsSummaryByUsageDataOutputDto>(WaterMeterReplacements, @params);
