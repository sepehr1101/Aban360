...
{
    internal sealed class SewageWaterRequestSummaryByZoneQueryService : AbstractBaseConnection, ISewageWaterRequestSummaryByZoneQueryService
    {
        ...
        public async Task<ReportOutput<SewageWaterRequestHeaderOutputDto, SewageWaterRequestSummaryByZoneDataOutputDto>> Get(SewageWaterRequestInputDto input)
        {
            ...
            IEnumerable<SewageWaterRequestSummaryByZoneDataOutputDto> RequestData = await _sqlReportConnection.QueryAsync<SewageWaterRequestSummaryByZoneDataOutputDto>(RequestSummaryQuery, @params);
