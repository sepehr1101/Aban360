...
{
    internal sealed class SewageWaterInstallationSummaryByUsageGroupQueryService : RequestOrInstallBase, ISewageWaterInstallationSummaryByUsageGroupQueryService
    {
        public SewageWaterInstallationSummaryByUsageGroupQueryService(IConfiguration configuration)
            : base(configuration)
        {
        }

        public async Task<ReportOutput<SewageWaterInstallationHeaderOutputDto, SewageWaterInstallationSummaryDataOutputDto>> Get(SewageWaterInstallationByUsageGroupInputDto input)
        {
            string reportTitle = (input.IsWater ? ReportLiterals.WaterInstallationSummary : ReportLiterals.SewageInstallationSummary) + ReportLiterals.ByUsageGroup;
            string query = GetGroupedByUsageGroupQuery(input.IsWater, InstallOrRequestOrInstallDepartmentEnum.Install);
