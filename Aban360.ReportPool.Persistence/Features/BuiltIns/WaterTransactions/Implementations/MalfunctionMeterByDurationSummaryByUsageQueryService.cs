...
{
    internal sealed class MalfunctionMeterByDurationSummaryByUsageQueryService : AbstractBaseConnection, IMalfunctionMeterByDurationSummaryByUsageQueryService
    {
