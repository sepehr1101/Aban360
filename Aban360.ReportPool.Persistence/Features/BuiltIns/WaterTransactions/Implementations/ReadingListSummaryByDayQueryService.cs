...
{
    internal sealed class ReadingListSummaryByDayQueryService : AbstractBaseConnection, IReadingListSummaryByDayQueryService
    {
        public ReadingListSummaryByDayQueryService(IConfiguration configuration)
            : base(configuration)
        { }
