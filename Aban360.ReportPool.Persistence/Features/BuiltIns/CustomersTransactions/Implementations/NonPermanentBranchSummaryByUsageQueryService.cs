...
{
    internal sealed class NonPermanentBranchSummaryByUsageQueryService : AbstractBaseConnection, INonPermanentBranchSummaryByUsageQueryService
    {
        public NonPermanentBranchSummaryByUsageQueryService(IConfiguration configuration)
            : base(configuration)
        {
        }
        public async Task<ReportOutput<NonPermanentBranchHeaderOutputDto, NonPermanentBranchSummaryByUsageDataOutputDto>> GetInfo(NonPermanentBranchByUsageAndZoneInputDto input)
        {
            ...
            IEnumerable<NonPermanentBranchSummaryByUsageDataOutputDto> nonPremanentBranchData = await _sqlReportConnection.QueryAsync<NonPermanentBranchSummaryByUsageDataOutputDto>(nonPremanentBranchQuery, @params);
            ...
            var result = new ReportOutput<NonPermanentBranchHeaderOutputDto, NonPermanentBranchSummaryByUsageDataOutputDto>(ReportLiterals.NonPermanentBranchSummary + ReportLiterals.ByUsage, nonPremanentBranchHeader, nonPremanentBranchData);
