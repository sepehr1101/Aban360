namespace Aban360.ReportPool.Domain.Constants
{
    public static class GroupingFields
    {
        ...
        public static string DeletionStateId = nameof(DeletionStateId);
        public static string DeletionStateTitle = nameof(DeletionStateTitle);
        public static string UsageStateId = nameof(UsageStateId);
        public static string BranchType = nameof(BranchType);
