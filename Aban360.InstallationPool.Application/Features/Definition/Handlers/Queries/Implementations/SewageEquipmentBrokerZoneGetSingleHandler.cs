...
{
    internal sealed class SewageEquipmentBrokerZoneGetSingleHandler : ISewageEquipmentBrokerZoneGetSingleHandler
    {
        private readonly IMapper _mapper;
        private readonly ISewageEquipmentBrokerZoneQueryService _sewageEquipmentBrokerZoneQueryService;
        public SewageEquipmentBrokerZoneGetSingleHandler(
            IMapper mapper,
        ...
        public async Task<SewageEquipmentBrokerZoneGetDto> Handle(short id, CancellationToken cancellationToken)
        {
            var sewageEquipmentBrokerZone = await _sewageEquipmentBrokerZoneQueryService.Get(id);
            return _mapper.Map<SewageEquipmentBrokerZoneGetDto>(sewageEquipmentBrokerZone);
        }
    }
}
