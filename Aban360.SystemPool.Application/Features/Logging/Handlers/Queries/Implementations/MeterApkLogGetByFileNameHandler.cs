...
{
    internal sealed class MeterApkLogGetByFileNameHandler : IMeterApkLogGetByFileNameHandler
    {
        private string _folderPath = @"AppData\MeterApkLogs";
        public MeterApkLogFileGetDto Handle(string fileName, CancellationToken cancellationToken)
        {
            ...
            return new MeterApkLogFileGetDto(fileName, content, fileInfo.LastWriteTime.ToPersianDateTimeString("yyyy/MM/dd - hh:mm:ss"));
        }
    }
}
