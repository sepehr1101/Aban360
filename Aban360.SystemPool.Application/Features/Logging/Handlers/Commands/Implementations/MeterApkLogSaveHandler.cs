...
{
    internal sealed class MeterApkLogSaveHandler : IMeterApkLogSaveHandler
    {
        private string _path = @"AppData\MeterApkLogs";
        public async Task Handle(MeterApkLogInsertDto input, CancellationToken cancellationToken)
        {
