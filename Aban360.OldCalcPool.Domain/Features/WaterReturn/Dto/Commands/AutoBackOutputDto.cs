...
{
    public record AutoBackOutputDto
    {
        //Barge Mohlat Jam Type Ser Ab10 Ab20 Masjar sabt Mamor ZaribCntr  RangeMas TafBack    TabAbnA TabAbnF TabsFa TmpDateBed ,TmpPriDate , TmpTodayDate, TmpMohlat, TmpTavizDate
