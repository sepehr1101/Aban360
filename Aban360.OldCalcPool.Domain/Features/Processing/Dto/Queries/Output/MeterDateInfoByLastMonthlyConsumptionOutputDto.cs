namespace Aban360.OldCalcPool.Domain.Features.Processing.Dto.Queries.Output
{
    public record MeterDateInfoByLastMonthlyConsumptionOutputDto
    {
        ...
        public MeterDateInfoByLastMonthlyConsumptionOutputDto(string billId, string previousDate, string currentDate, decimal meetingNumber, int invoiceId, int cause, bool shouldSave)
        {
            BillId = billId;
