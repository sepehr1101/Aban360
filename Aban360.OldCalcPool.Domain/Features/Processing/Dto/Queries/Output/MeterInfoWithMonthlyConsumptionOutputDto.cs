...
{
    public record MeterInfoWithMonthlyConsumptionOutputDto
    {
        ...
        public MeterInfoWithMonthlyConsumptionOutputDto(string billId, string previousDate, string currentDate, double monthlyAverageConsumption, decimal meetingNumber, int invoiceId, int cause, bool shouldSave)
        {
            BillId = billId;
        ...
        public MeterInfoWithMonthlyConsumptionOutputDto()
        {
