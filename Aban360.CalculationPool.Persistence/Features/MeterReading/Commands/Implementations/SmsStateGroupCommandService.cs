...
{
    public class SmsStateGroupCommandService
    {
        private readonly IDbConnection _connection;
        private readonly IDbTransaction _transaction;
        public SmsStateGroupCommandService(IDbConnection connection, IDbTransaction transaction)
        {
        ...
        {
            return @"INSERT INTO Atlas.dbo.SmsStateGroup(Title)
                    VALUES(@Title)";
        }
    }
}
