...
{
    public class Article11Seeder : AbstractBaseConnection,IDataSeeder
    {
        public int Order { get; set; } = 10;

        public Article11Seeder(IConfiguration configuration)
            :base(configuration)
        {
        }
        ...
        private string GetSqlFilePath()
        {
            ...
            string relativePath = @"\DbSeeder\DataScript\Article11.sql";
