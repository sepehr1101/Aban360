...
{
    public class InstallationAndEquipmentSeeder : AbstractBaseConnection, IDataSeeder
    {
        public int Order { get; set; } = 10;

        public InstallationAndEquipmentSeeder(IConfiguration configuration)
            : base(configuration)
        {
        }
        ...
        private string GetSqlFilePath()
        {
            ...
            string relativePath = @"\DbSeeder\DataScript\InstallationAndEquipment.sql";
        ...
        private string GetQuery()
        {
            return @"Select COUNT(1)
                    From [Aban360].CalculationPool.InstallationAndEquipment";
        }
    }
}
