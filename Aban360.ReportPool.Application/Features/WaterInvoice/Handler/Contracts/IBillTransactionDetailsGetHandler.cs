...
namespace Aban360.ReportPool.Application.Features.WaterInvoice.Handler.Contracts
{
    ...
    {
        Task<ReportOutput<BillTransactionDetailHeaderOutputDto, BillTransactionDetailDataOutputDto>> Handle(string billId, IAppUser appUser, CancellationToken cancellationToken);
    }
}
