...
{
    internal sealed class WaterPaymentReceivableDetailHandler : IWaterPaymentReceivableDetailHandler
    {
        private readonly IWaterPaymentReceivableQueryDetailService _waterPaymentReceivableQueryService;
        private readonly IValidator<WaterPaymentReceivableInputDto> _validator;
        public WaterPaymentReceivableDetailHandler(
            IWaterPaymentReceivableQueryDetailService waterPaymentReceivableQueryService,
