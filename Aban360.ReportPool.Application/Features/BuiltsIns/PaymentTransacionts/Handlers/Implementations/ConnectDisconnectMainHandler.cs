...
{
    internal sealed class ConnectDisconnectMainHandler : IConnectDisconnectMainHandler
    {
        ...
        public ConnectDisconnectMainHandler(
        ...
        public async Task<ReportOutput<ConnectDisconnectMainHeaderOutputDto, ConnectDisconnectMainDataOutputDto>> Handle(ConnectDisconnectMainInputDto inputDto, CancellationToken cancellationToken)
        {
            ...
            IEnumerable<ConnectDisconnectMainDataOutputDto> data = await _connectDisconnectQueryService.Get(inputDto);
            ...
            return new ReportOutput<ConnectDisconnectMainHeaderOutputDto, ConnectDisconnectMainDataOutputDto>(_title, header, data);
        }
    }
}
