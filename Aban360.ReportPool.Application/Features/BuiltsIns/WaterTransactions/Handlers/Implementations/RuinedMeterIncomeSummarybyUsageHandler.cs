...
{
    internal sealed class RuinedMeterIncomeSummarybyUsageHandler : IRuinedMeterIncomeSummarybyUsageHandler
    {
        private readonly IRuinedMeterIncomeSummaryByUsageQueryService _ruinedMeterIncomeQueryService;
        private readonly IValidator<RuinedMeterIncomeInputDto> _validator;
        public RuinedMeterIncomeSummarybyUsageHandler(
            IRuinedMeterIncomeSummaryByUsageQueryService ruinedMeterIncomeQueryService,
