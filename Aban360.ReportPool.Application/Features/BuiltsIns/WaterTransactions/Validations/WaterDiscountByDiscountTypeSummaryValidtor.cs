...
{
    public class WaterDiscountByDiscountTypeSummaryValidtor : BaseValidator<WaterDiscountByTypeSummaryInputDto>
    {
        public WaterDiscountByDiscountTypeSummaryValidtor()
        {
            RuleFor(w => w.ZoneIds)
