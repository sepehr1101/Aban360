...
{
    public class SewageWaterRequestByUsageGroupValidator : BaseValidator<SewageWaterRequestByUsageGroupInputDto>
    {
        public SewageWaterRequestByUsageGroupValidator()
        {
