...
{
    public class SewageWaterDistanceofRequestAndInstallationByZoneValidator : BaseValidator<SewageWaterDistanceofRequestAndInstallationByZoneInputDto>
    {
        public SewageWaterDistanceofRequestAndInstallationByZoneValidator()
        {
