...
{
    public class ServiceLinkModifiedBillValidator : BaseValidator<ServiceLinkModifiedBillsInputDto>
    {
        public ServiceLinkModifiedBillValidator()
        {
          ...
          .NotNull().WithMessage(ExceptionLiterals.NotNull);
           ...
           .NotNull().WithMessage(ExceptionLiterals.NotNull);
            ...
            RuleFor(customer => customer.TypeId)
           .NotEmpty().WithMessage(ExceptionLiterals.NotNull)
           .NotNull().WithMessage(ExceptionLiterals.NotNull);
        }
    }
