...
{
    public class SewageWaterRequestWithStringCodeValidator : BaseValidator<SewageWaterRequestWithStringCodeInputDto>
    {
        public SewageWaterRequestWithStringCodeValidator()
        {
