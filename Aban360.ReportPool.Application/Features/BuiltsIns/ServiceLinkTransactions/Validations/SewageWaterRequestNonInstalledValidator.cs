...
{
    public class SewageWaterRequestNonInstalledValidator : BaseValidator<SewageWaterRequestNonInstalledInputDto>
    {
        public SewageWaterRequestNonInstalledValidator()
        {
