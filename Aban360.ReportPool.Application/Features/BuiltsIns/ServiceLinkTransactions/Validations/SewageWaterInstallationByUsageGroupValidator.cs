...
{
    public class SewageWaterInstallationByUsageGroupValidator : BaseValidator<SewageWaterInstallationByUsageGroupInputDto>
    {
        public SewageWaterInstallationByUsageGroupValidator()
        {
            ...
            RuleFor(installation => installation.UsageGroupId)
                .NotEmpty().WithMessage(ExceptionLiterals.NotNull)
                .NotNull().WithMessage(ExceptionLiterals.NotNull);
