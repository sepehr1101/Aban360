...
{
    internal sealed class UseStateReportSummaryByUsageZoneHandler : IUseStateReportSummaryByUsageZoneHandler
    {
        private readonly IUseStateReportSummaryByUsageZoneQueryService _userStateReportQueryService;
        private readonly IValidator<UseStateReportInputDto> _validator;
        public UseStateReportSummaryByUsageZoneHandler(
            IUseStateReportSummaryByUsageZoneQueryService userStateReportQueryService,
