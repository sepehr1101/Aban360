...
{
    internal sealed class SewageWaterInstallationSummaryByZoneIdGroupingHandler : ISewageWaterInstallationSummaryByZoneIdGroupingHandler
    {
        ...
        public SewageWaterInstallationSummaryByZoneIdGroupingHandler(
