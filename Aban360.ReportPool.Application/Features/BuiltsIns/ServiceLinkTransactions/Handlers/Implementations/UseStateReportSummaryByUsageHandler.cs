...
{
    internal sealed class UseStateReportSummaryByUsageHandler : IUseStateReportByUsageHandler
    {
        ...
        public async Task<ReportOutput<UseStateReportHeaderSummaryOutputDto, UseStateReportSummaryByUsageDataOutputDto>> Handle(UseStateReportInputDto input, CancellationToken cancellationToken)
        {
            ...
            ReportOutput<UseStateReportHeaderSummaryOutputDto, UseStateReportSummaryByUsageDataOutputDto> useStateReports = await _userStateReportQueryService.Get(input);
