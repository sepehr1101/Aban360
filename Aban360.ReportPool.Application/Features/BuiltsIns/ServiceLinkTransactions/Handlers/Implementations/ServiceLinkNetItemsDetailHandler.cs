...
namespace Aban360.ReportPool.Application.Features.BuiltsIns.ServiceLinkTransactions.Handlers.Implementations
{
    internal sealed class ServiceLinkNetItemsDetailHandler : IServiceLinkNetItemsDetailHandler
    {
        ...
        public async Task<ReportOutput<ServiceLinkNetItemsHeaderOutputDto, ServiceLinkRawNetItemsDetailDataOutputDto>> Handle(ServiceLinkNetItemsInputDto input, CancellationToken cancellationToken)
        {
