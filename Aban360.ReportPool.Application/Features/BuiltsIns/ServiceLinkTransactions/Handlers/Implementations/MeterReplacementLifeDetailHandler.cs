...
{
    internal sealed class MeterReplacementLifeDetailHandler : IMeterReplacementLifeDetailHandler
    {
        private readonly IMeterReplacementLifeDetailQueryService _meterReplacementLifeService;
        private readonly IValidator<MeterReplacementLifeInputDto> _validator;
        public MeterReplacementLifeDetailHandler(
            IMeterReplacementLifeDetailQueryService meterReplacementLifeService,
