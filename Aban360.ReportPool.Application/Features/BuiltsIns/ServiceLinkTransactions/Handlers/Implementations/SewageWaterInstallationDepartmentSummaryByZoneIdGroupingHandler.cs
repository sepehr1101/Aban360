...
{
    internal sealed class SewageWaterInstallationDepartmentSummaryByZoneIdGroupingHandler : ISewageWaterInstallationDepartmentSummaryByZoneIdGroupingHandler
    {
        ...
        public SewageWaterInstallationDepartmentSummaryByZoneIdGroupingHandler(
        ...
        public async Task<ReportOutput<SewageWaterInstallationHeaderOutputDto, ReportOutput<SewageWaterInstallationSummaryByZoneIdDateOutputDto, SewageWaterInstallationSummaryByZoneIdDateOutputDto>>> Handle(SewageWaterInstallationInputDto input, CancellationToken cancellationToken)
        {
            ...
            IEnumerable<ReportOutput<SewageWaterInstallationSummaryByZoneIdDateOutputDto, SewageWaterInstallationSummaryByZoneIdDateOutputDto>> dataGroup = result
                .ReportData
                .GroupBy(m => m.RegionTitle) // فقط بر اساس RegionId گروه‌بندی
                .Select(g => new ReportOutput<SewageWaterInstallationSummaryByZoneIdDateOutputDto, SewageWaterInstallationSummaryByZoneIdDateOutputDto>
                (
                    result.Title,
                    new SewageWaterInstallationSummaryByZoneIdDateOutputDto
                    {
                    ...
                    g.Select(v => new SewageWaterInstallationSummaryByZoneIdDateOutputDto
                    {
