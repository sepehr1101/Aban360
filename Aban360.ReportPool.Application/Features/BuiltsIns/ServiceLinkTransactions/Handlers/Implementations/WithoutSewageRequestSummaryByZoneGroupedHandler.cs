...
{
    internal sealed class WithoutSewageRequestSummaryByZoneGroupedHandler : IWithoutSewageRequestSummaryByZoneGroupedHandler
    {
        ...
        public WithoutSewageRequestSummaryByZoneGroupedHandler(
        ...
        public async Task<ReportOutput<WithoutSewageRequestHeaderOutputDto, ReportOutput<WithoutSewageRequestSummaryByZoneGroupedDataOutputDto, WithoutSewageRequestSummaryByZoneGroupedDataOutputDto>>> Handle(WithoutSewageRequestInputDto input, CancellationToken cancellationToken)
        {
            ...
            IEnumerable<ReportOutput<WithoutSewageRequestSummaryByZoneGroupedDataOutputDto, WithoutSewageRequestSummaryByZoneGroupedDataOutputDto>> dataGroup = result
                .ReportData
                .GroupBy(m => m.RegionTitle) // فقط بر اساس RegionId گروه‌بندی
                .Select(g => new ReportOutput<WithoutSewageRequestSummaryByZoneGroupedDataOutputDto, WithoutSewageRequestSummaryByZoneGroupedDataOutputDto>
                (
                    result.Title,
                    new WithoutSewageRequestSummaryByZoneGroupedDataOutputDto
                    {
                    ...
                    g.Select(v => new WithoutSewageRequestSummaryByZoneGroupedDataOutputDto
                    {
