            ...
            IEnumerable<ReportOutput<ReadingIssueDistanceBillSummryDataOutputDto, ReadingIssueDistanceBillSummryDataOutputDto>> dataGroup = result
                  ...
                  (
                      ...
                      new ReadingIssueDistanceBillSummryDataOutputDto
                      {
                          ...
                          CommercialUnit = (float)g.Sum(s => s.CommercialUnit),
                          DomesticUnit = (float)g.Sum(s => s.DomesticUnit),
                          OtherUnit = (float)g.Sum(s => s.OtherUnit),
                          TotalUnit = (float)g.Sum(s => s.TotalUnit),
                          CustomerCount = g.Sum(s => s.CustomerCount),
                          UnSpecified = (float)g.Average(s => s.UnSpecified),
                          Field0_5 = (float)g.Average(s => s.Field0_5),
                          Field0_75 = (float)g.Average(s => s.Field0_75),
                          Field1 = (float)g.Average(s => s.Field1),
                          Field1_2 = (float)g.Average(s => s.Field1_2),
                          Field1_5 = (float)g.Average(s => s.Field1_5),
                          Field2 = (float)g.Average(s => s.Field2),
                          Field3 = (float)g.Average(s => s.Field3),
                          Field4 = (float)g.Average(s => s.Field4),
                          Field5 = (float)g.Average(s => s.Field5),
                          MoreThan6 = (float)g.Average(s => s.MoreThan6),
                          UnSpecifiedText = CalculationDistanceDate.ConvertDaysToDate((int)g.Average(s => s.UnSpecified)),
                          Field0_5Text = CalculationDistanceDate.ConvertDaysToDate((int)g.Average(s => s.Field0_5)),
                          Field0_75Text = CalculationDistanceDate.ConvertDaysToDate((int)g.Average(s => s.Field0_75)),
                          Field1Text = CalculationDistanceDate.ConvertDaysToDate((int)g.Average(s => s.Field1)),
                          Field1_2Text = CalculationDistanceDate.ConvertDaysToDate((int)g.Average(s => s.Field1_2)),
                          Field1_5Text = CalculationDistanceDate.ConvertDaysToDate((int)g.Average(s => s.Field1_5)),
                          Field2Text = CalculationDistanceDate.ConvertDaysToDate((int)g.Average(s => s.Field2)),
                          Field3Text = CalculationDistanceDate.ConvertDaysToDate((int)g.Average(s => s.Field3)),
                          Field4Text = CalculationDistanceDate.ConvertDaysToDate((int)g.Average(s => s.Field4)),
                          Field5Text = CalculationDistanceDate.ConvertDaysToDate((int)g.Average(s => s.Field5)),
                          MoreThan6Text = CalculationDistanceDate.ConvertDaysToDate((int)g.Average(s => s.MoreThan6)),
                      },
