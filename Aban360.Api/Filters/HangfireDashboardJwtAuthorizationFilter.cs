    ...
    public class HangfireDashboardJwtAuthorizationFilter : IDashboardAuthorizationFilter
    {
        ...
        public bool Authorize(DashboardContext context)
        {
            ...
            if (httpContext.Request.Query.ContainsKey("access_token") &&
                (path.StartsWithSegments("/main/admin/hangfire") || path.StartsWithSegments("/aban360/main/admin/hangfire") ||
                 pathBase.StartsWithSegments("/main/admin/hangfire") || pathBase.StartsWithSegments("/aban360/main/admin/hangfire")))
            {
