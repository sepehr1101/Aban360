...
{
    [Route("v1/water-payment-receivable-detail")]
    public class WaterPaymentReceivableDetailController : BaseController
    {
        private readonly IWaterPaymentReceivableDetailHandler _waterPaymentReceivable;
        private readonly IReportGenerator _reportGenerator;
        public WaterPaymentReceivableDetailController(
            IWaterPaymentReceivableDetailHandler waterPaymentReceivable,
        ...
        {
            await _reportGenerator.FireAndInform(inputDto, cancellationToken, _waterPaymentReceivable.Handle, CurrentUser, ReportLiterals.WaterPaymentReceivableDetail, connectionId);
            return Ok(inputDto);
        }
        ...
        {
            int reportCode = 570;
            ReportOutput<WaterPaymentReceivableHeaderOutputDto, WaterPaymentReceivableDataOutputDto> result = await _waterPaymentReceivable.Handle(inputDto, cancellationToken);
