...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.PaymentsTransactions
{
    ...
    public class BankGroupedController : BaseController
    {
        ...
        public async Task<IActionResult> GetStiReport(BankGroupedInputDto inputDto, CancellationToken cancellationToken)
        {
            int reportCode = 490;
            ReportOutput<BankGroupedHeaderOutputDto, BankGroupedDataOutputDto> result = await _bankGrouped.Handle(inputDto, cancellationToken);
