...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.PaymentsTransactions
{
    ...
    public class WaterUsageGroupedController : BaseController
    {
        ...
        {
            int reportCode = 471;
            ReportOutput<ServiceLinkWaterItemGroupedHeaderOutputDto, ServiceLinkWaterItemGroupedDataOutputDto> result = await _waterUsageGrouped.Handle(inputDto, cancellationToken);
