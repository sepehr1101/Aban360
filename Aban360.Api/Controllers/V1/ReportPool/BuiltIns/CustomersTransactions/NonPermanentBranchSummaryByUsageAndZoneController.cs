...
{
    [Route("v1/non-permanent-branch-summary-by-usage-and-zone")]
    public class NonPermanentBranchSummaryByUsageAndZoneController : BaseController
    {
        ...
        {
            ReportOutput<NonPermanentBranchHeaderOutputDto, NonPermanentBranchGroupedDataOutputDto> nonPremanentBranchSummaryByUsageAndZone = await _nonPermanentBranchSummaryByUsageAndZone.Handle(inputDto, cancellationToken);
        ...
        {
            int reportCode = 105;
            ReportOutput<NonPermanentBranchHeaderOutputDto, NonPermanentBranchGroupedDataOutputDto> nonPermanentBranch = await _nonPermanentBranchSummaryByUsageAndZone.Handle(inputDto, cancellationToken);
