...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.CustomersTransactions
{
    ...
    public class CustomersSearchAdvancedController : BaseController
    {
        ...
        [AllowAnonymous]
        public async Task<IActionResult> GetStiReport(CustomerSearchAdvancedInputDto inputDto, CancellationToken cancellationToken)
        {
            int reportCode = 41;
            ReportOutput<CustomerSearchHeaderOutputDto, CustomerSearchDataOutputDto> customer = await _customerSearchAdvancedHandler.Handle(inputDto, cancellationToken);
