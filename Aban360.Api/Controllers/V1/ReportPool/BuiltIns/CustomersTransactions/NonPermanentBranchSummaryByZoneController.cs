...
{
    [Route("v1/non-permanent-branch-summary-by-zone")]
    public class NonPermanentBranchSummaryByZoneController : BaseController
    {
        ...
        {
            ReportOutput<NonPermanentBranchHeaderOutputDto, NonPermanentBranchGroupedDataOutputDto> nonPremanentBranchSummaryByZone = await _nonPermanentBranchSummaryByZone.Handle(inputDto, cancellationToken);
        ...
        {
            int reportCode = 102;
            ReportOutput<NonPermanentBranchHeaderOutputDto, NonPermanentBranchGroupedDataOutputDto> nonPermanentBranch = await _nonPermanentBranchSummaryByZone.Handle(inputDto, cancellationToken);
