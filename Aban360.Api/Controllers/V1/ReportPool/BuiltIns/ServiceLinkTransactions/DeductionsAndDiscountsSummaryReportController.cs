...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.ServiceLinkTransactions
{
    ...
    public class DeductionsAndDiscountsSummaryReportController : BaseController
    {
        ...
        [AllowAnonymous]
        public async Task<IActionResult> GetStiReport(DeductionsAndDiscountsReportInputDto inputDto, CancellationToken cancellationToken)
        {
            int reportCode = 208;
            ReportOutput<DeductionsAndDiscountsReportHeaderOutputDto, DeductionsAndDiscountsReportSummaryDataOutputDto> nonPermanentBranch = await _deductionsAndDiscountsSummaryReportHandler.Handle(inputDto, cancellationToken);
