...
{
    [Route("v1/sewage-water-request-Summary-by-zone-with-string-code")]
    public class SewageWaterRequestSummaryByZoneWithStringCodeController : BaseController
    {
        private readonly ISewageWaterRequestSummaryByZoneWithStringCodeHandler _sewageWaterRequestSummaryByZoneHandler;
        private readonly IReportGenerator _reportGenerator;
        public SewageWaterRequestSummaryByZoneWithStringCodeController(
            ISewageWaterRequestSummaryByZoneWithStringCodeHandler sewageWaterRequestSummaryByZoneHandler,
        ...
        public async Task<IActionResult> GetExcel(string connectionId, SewageWaterRequestWithStringCodeInputDto inputDto, CancellationToken cancellationToken)
        {
