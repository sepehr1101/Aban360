...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.ServiceLinkTransactions
{
    ...
    public class LinkServiceStatementController : BaseController
    {
        ...
        {
            int reportCode = 600;
            ReportOutput<LinkServiceStatementHeaderOutputDto, LinkServiceStatementDataOutputDto> result = await _linkServiceStatementHandler.Handle(inputDto, cancellationToken);
