...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.ServiceLinkTransactions
{
    ...
    public class ServiceLinkModifiedBillsDetailController : BaseController
    {
        ...
        {
            int reportCode = 630;
            ReportOutput<ServiceLinkModifiedBillsHeaderOutputDto, ServiceLinkModifiedBillsDetailDataOutputDto> result = await _modifiedBillsHandler.Handle(inputDto, cancellationToken);
