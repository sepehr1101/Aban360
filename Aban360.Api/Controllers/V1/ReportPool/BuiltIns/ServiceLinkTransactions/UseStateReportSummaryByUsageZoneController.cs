...
{
    [Route("v1/use-state-report-summary-by-usage-zone")]
    public class UseStateReportSummaryByUsageZoneController : BaseController
    {
        private readonly IUseStateReportSummaryByUsageZoneHandler _useStateReportSummaryByUsageHandler;
        private readonly IReportGenerator _reportGenerator;
        public UseStateReportSummaryByUsageZoneController(
            IUseStateReportSummaryByUsageZoneHandler useStateReportSummaryByUsageHandler,
        ...
        {
            ReportOutput<UseStateReportHeaderSummaryOutputDto, UseStateReportSummaryDataOutputDto> useStates = await _useStateReportSummaryByUsageHandler.Handle(inputDto, cancellationToken);
            return Ok(useStates);
        }
