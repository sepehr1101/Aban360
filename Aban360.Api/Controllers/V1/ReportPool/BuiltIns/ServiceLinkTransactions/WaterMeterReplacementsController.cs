...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.ServiceLinkTransactions
{
    ...
    public class WaterMeterReplacementsController : BaseController
    {
        ...
        {
            int reportCode = 250;
            ReportOutput<WaterMeterReplacementsHeaderOutputDto, WaterMeterReplacementsDataOutputDto> waterMeterReplacements = await _waterMeterReplacementsHandler.Handle(inputDto, cancellationToken);
