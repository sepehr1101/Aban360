...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.ServiceLinkTransactions
{
    ...
    public class WaterMeterReplacementsSummaryByUsageController : BaseController
    {
        ...
        {
            int reportCode = 251;
            ReportOutput<WaterMeterReplacementsHeaderOutputDto, WaterMeterReplacementsSummaryDataOutputDto> waterMeterReplacements = await _waterMeterReplacementsSummaryByUsageHandler.Handle(inputDto, cancellationToken);
