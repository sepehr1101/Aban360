...
{
    [Route("v1/sewage-water-request-summary-by-usage-group")]
    public class SewageWaterRequestSummaryByUsageGroupController : BaseController
    {
        private readonly ISewageWaterRequestSummaryByUsageGroupHandler _sewageWaterRequestSummaryHandler;
        private readonly IReportGenerator _reportGenerator;
        public SewageWaterRequestSummaryByUsageGroupController(
            ISewageWaterRequestSummaryByUsageGroupHandler sewageWaterRequestSummaryHandler,
        ...
        public async Task<IActionResult> GetExcel(string connectionId, SewageWaterRequestByUsageGroupInputDto inputDto, CancellationToken cancellationToken)
        {
            string reportName = inputDto.IsWater ? ReportLiterals.WaterRequestSummary + ReportLiterals.ByUsageGroup : ReportLiterals.SewageRequestSummary + ReportLiterals.ByUsageGroup;
