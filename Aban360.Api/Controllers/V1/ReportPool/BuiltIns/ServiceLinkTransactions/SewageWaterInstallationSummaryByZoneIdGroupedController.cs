...
{
    [Route("v1/sewage-water-installation-summary-by-zoneId-grouped")]
    public class SewageWaterInstallationSummaryByZoneIdGroupedController : BaseController
    {
        ...
        public SewageWaterInstallationSummaryByZoneIdGroupedController(
        ...
        {
            string reportName = (inputDto.IsWater ? ReportLiterals.WaterInstallationSummary : ReportLiterals.SewageInstallationSummary) + ReportLiterals.ByZone;
            await _reportGenerator.FireAndInform(inputDto, cancellationToken, _sewageWaterInstallationSummaryByZoneIdGroupingHandler.HandleFlat, CurrentUser, reportName, connectionId, ReportLiterals.HandleFlat);
            return Ok(inputDto);
        }
