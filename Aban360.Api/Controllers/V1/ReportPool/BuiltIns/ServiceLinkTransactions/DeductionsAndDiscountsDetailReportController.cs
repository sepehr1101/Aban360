...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.ServiceLinkTransactions
{
    ...
    public class DeductionsAndDiscountsDetailReportController : BaseController
    {
        ...
        {
            int reportCode = 200;
            ReportOutput<DeductionsAndDiscountsReportHeaderOutputDto, DeductionsAndDiscountsReportDetailDataOutputDto> nonPermanentBranch = await _deductionsAndDiscountsDetailReportHandler.Handle(inputDto, cancellationToken);
