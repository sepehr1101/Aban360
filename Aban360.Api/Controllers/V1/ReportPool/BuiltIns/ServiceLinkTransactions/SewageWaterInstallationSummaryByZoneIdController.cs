...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.ServiceLinkTransactions
{
    ...
    public class SewageWaterInstallationSummaryByZoneIdController : BaseController
    {
        ...
        {
            int reportCode = 242;
            ReportOutput<SewageWaterInstallationHeaderOutputDto, SewageWaterInstallationSummaryByZoneIdDataOutputDto> calculationDetails = await _sewageWaterInstallationSummaryByZoneIdHandler.Handle(inputDto, cancellationToken);
