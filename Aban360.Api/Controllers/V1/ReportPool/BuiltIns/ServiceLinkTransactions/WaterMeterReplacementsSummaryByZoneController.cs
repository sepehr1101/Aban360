...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.ServiceLinkTransactions
{
    ...
    public class WaterMeterReplacementsSummaryByZoneController : BaseController
    {
        ...
        {
            int reportCode = 252;
            ReportOutput<WaterMeterReplacementsHeaderOutputDto, WaterMeterReplacementsSummaryDataOutputDto> waterMeterReplacements = await _waterMeterReplacementsSummaryByZoneHandler.Handle(inputDto, cancellationToken);
