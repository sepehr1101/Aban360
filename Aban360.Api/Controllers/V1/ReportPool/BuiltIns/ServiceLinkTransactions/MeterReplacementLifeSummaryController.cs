...
{
    [Route("v1/meter-replacement-life-summary")]
    public class MeterReplacementLifeSummaryController : BaseController
    {
        private readonly IMeterReplacementLifeSummaryHandler _meterReplacementLifeHandler;
        private readonly IReportGenerator _reportGenerator;
        public MeterReplacementLifeSummaryController(
            IMeterReplacementLifeSummaryHandler meterReplacementLifeHandler,
        ...
        {
            await _reportGenerator.FireAndInform(inputDto, cancellationToken, _meterReplacementLifeHandler.Handle, CurrentUser, ReportLiterals.MeterReplacementLifeSummary, connectionId);
            return Ok(inputDto);
        }
