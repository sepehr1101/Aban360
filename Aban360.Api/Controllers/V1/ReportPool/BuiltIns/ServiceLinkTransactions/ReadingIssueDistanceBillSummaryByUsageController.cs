...
{
    [Route("v1/reading-issue-distancebill-summary-by-usage")]
    public class ReadingIssueDistanceBillSummaryByUsageController : BaseController
    {
        private readonly IReadingIssueDistanceBillSummaryByUsageHandler _readingIssueDistanceHandler;
        private readonly IReportGenerator _reportGenerator;
        public ReadingIssueDistanceBillSummaryByUsageController(
            IReadingIssueDistanceBillSummaryByUsageHandler readingIssueDistanceHandler,
        ...
        {
            await _reportGenerator.FireAndInform(inputDto, cancellationToken, _readingIssueDistanceHandler.Handle, CurrentUser, ReportLiterals.ReadingIssueDistanceBillSummary + ReportLiterals.ByUsage, connectionId);
            return Ok(inputDto);
        }
        ...
        {
            int reportCode = 421;
            ReportOutput<ReadingIssueDistanceBillHeaderOutputDto, ReadingIssueDistanceBillSummryDataOutputDto> readingIssueDistance = await _readingIssueDistanceHandler.Handle(inputDto, cancellationToken);
