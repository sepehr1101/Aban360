...
{
    [Route("v1/water-distnace-deliver-to-install-summary-by-zone")]
    public class WaterDistanceDeliverToInstallSummaryByZoneController : BaseController
    {
        private readonly IWaterDistanceDeliverToInstallSummaryByZoneHandler _waterDistanceDeliverToInstallSummaryHandler;
        private readonly IReportGenerator _reportGenerator;
        public WaterDistanceDeliverToInstallSummaryByZoneController(
            IWaterDistanceDeliverToInstallSummaryByZoneHandler waterDistanceDeliverToInstallSummaryHandler,
