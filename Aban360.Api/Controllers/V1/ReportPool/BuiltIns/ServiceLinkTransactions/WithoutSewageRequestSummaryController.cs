...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.ServiceLinkTransactions
{
    ...
    public class WithoutSewageRequestSummaryController : BaseController
    {
        ...
        {
            ReportOutput<WithoutSewageRequestHeaderOutputDto, WithoutSewageRequestSummaryDataOutputDto> result = await _withoutSewageRequestSummaryHandler.Handle(input, cancellationToken);
            return Ok(result);
        }
        ...
        {
            int reportCode = 621;
            ReportOutput<WithoutSewageRequestHeaderOutputDto, WithoutSewageRequestSummaryDataOutputDto> result = await _withoutSewageRequestSummaryHandler.Handle(inputDto, cancellationToken);
