...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.WaterMeterTransactions
{
    ...
    public class ReadingStatusStatementSummaryByZoneGroupedController : BaseController
    {
        ...
        {
            await _reportGenerator.FireAndInform(inputDto, cancellationToken, _readingStatusStatementSummaryByZoneGrouped.HandleFlat, CurrentUser, ReportLiterals.ReadingStatusStatementSummary + ReportLiterals.ByZone, connectionId, ReportLiterals.HandleFlat);
            return Ok(inputDto);
        }
        ...
        {
            int reportCode = 393;
            ReportOutput<ReadingStatusStatementHeaderOutputDto, ReadingStatusStatementSummaryDataOutputDto> statusStatement = await _readingStatusStatementSummaryByZoneGrouped.HandleFlat(inputDto, cancellationToken);
