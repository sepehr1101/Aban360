...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.WaterMeterTransactions
{
    ...
    public class WithoutBillSummaryByUsageController : BaseController
    {
        ...
        {
            int reportCode = 211;
            ReportOutput<WithoutBillHeaderOutputDto, WithoutBillSummaryDataOutputDto> nonPermanentBranch = await _withoutBillSummaryByUsageHandler.Handle(inputDto, cancellationToken);
