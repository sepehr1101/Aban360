...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.WaterMeterTransactions
{
    ...
    public class WaterModifiedBillsDetailController : BaseController
    {
        ...
        {
            int reportCode = 520;
            ReportOutput<WaterModifiedBillsHeaderOutputDto, WaterModifiedBillsDetailDataOutputDto> result = await _modifiedBillsHandler.Handle(inputDto, cancellationToken);
