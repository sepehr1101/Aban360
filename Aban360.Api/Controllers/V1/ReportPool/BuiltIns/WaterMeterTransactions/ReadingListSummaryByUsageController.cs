...
{
    [Route("v1/reading-list-summary-by-usage")]
    public class ReadingListSummaryByUsageController : BaseController
    {
        private readonly IReadingListSummaryByUsageHandler _readingListSummary;
        private readonly IReportGenerator _reportGenerator;
        public ReadingListSummaryByUsageController(
            IReadingListSummaryByUsageHandler readingListSummary,
        ...
        {
            await _reportGenerator.FireAndInform(inputDto, cancellationToken, _readingListSummary.Handle, CurrentUser, ReportLiterals.ReadingListSummary + ReportLiterals.ByUsage, connectionId);
            return Ok(inputDto);
        }
    }
}
