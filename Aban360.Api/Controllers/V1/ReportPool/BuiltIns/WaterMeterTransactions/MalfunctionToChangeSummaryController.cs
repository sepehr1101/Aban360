...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.WaterMeterTransactions
{
    ...
    public class MalfunctionToChangeSummaryController : BaseController
    {
        ...
        {
            int reportCode = 378;
            ReportOutput<MalfunctionToChangeHeaderOutputDto, MalfunctionToChangeSummaryDataOutputDto> result = await _malfunctionToChangeHandler.Handle(inputDto, cancellationToken);
