...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.WaterMeterTransactions
{
    ...
    public class WaterModifiedBillsSummaryController : BaseController
    {
        ...
        public WaterModifiedBillsSummaryController(
            IWaterModifiedBillsSummaryHandler modifiedBillsHandler,
        ...
        [HttpPost, HttpGet]
        [Route("raw")]
        [ProducesResponseType(typeof(ApiResponseEnvelope<ReportOutput<WaterModifiedBillsHeaderOutputDto, WaterModifiedBillsSummaryDataOutputDto>>), StatusCodes.Status200OK)]
        ...
        {
            await _reportGenerator.FireAndInform(inputDto, cancellationToken, _modifiedBillsHandler.Handle, CurrentUser, ReportLiterals.WaterModifiedBillsSummary, connectionId);
            return Ok(inputDto);
        }
        ...
        {
            int reportCode = 528;
            ReportOutput<WaterModifiedBillsHeaderOutputDto, WaterModifiedBillsSummaryDataOutputDto> result = await _modifiedBillsHandler.Handle(inputDto, cancellationToken);
