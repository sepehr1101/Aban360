...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.WaterMeterTransactions
{
    ...
    public class WaterCalculationDetailsController : BaseController
    {
        ...
        [AllowAnonymous]
        public async Task<IActionResult> GetStiReport(WaterCalculationDetailsInputDto inputDto, CancellationToken cancellationToken)
        {
            int reportCode = 80;
            ReportOutput<WaterCalculationDetailsHeaderOutputDto, WaterCalculationDetailsDataOutputDto> calculationDetails = await _calculationDetailsHandler.Handle(inputDto, cancellationToken);
