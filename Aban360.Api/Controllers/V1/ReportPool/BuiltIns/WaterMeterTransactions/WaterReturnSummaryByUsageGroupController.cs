...
{
    [Route("v1/water-return-summary-by-usage-group")]
    public class WaterReturnSummaryByUsageGroupController : BaseController
    {
        private readonly IWaterReturnSummaryByUsageGroupHandler _waterReturnSummary;
        private readonly IReportGenerator _reportGenerator;
        public WaterReturnSummaryByUsageGroupController(
            IWaterReturnSummaryByUsageGroupHandler waterReturnSummary,
        ...
        public async Task<IActionResult> GetRaw(WaterReturnSummaryByUsageGroupInputDto inputDto, CancellationToken cancellationToken)
        {
        ...
        public async Task<IActionResult> GetExcel(string connectionId, WaterReturnSummaryByUsageGroupInputDto inputDto, CancellationToken cancellationToken)
        {
