...
namespace Aban360.Api.Controllers.V1.ReportPool.BuiltIns.WaterMeterTransactions
{
    ...
    public class ReadingStatusStatementSummaryByZoneController : BaseController
    {
        ...
        {
            int reportCode = 392;
            ReportOutput<ReadingStatusStatementHeaderOutputDto, ReadingStatusStatementSummaryDataOutputDto> statusStatement = await _readingStatusStatementSummaryByZone.Handle(inputDto, cancellationToken);
