...
{
    [Route("v1/nerkh-11")]
    public class Nerkh11CreateController : BaseController
    {
        private readonly INerkhCreateHandler _nerkhCreateHandler;
        public Nerkh11CreateController(INerkhCreateHandler nerkhCreateHandler)
        {
        ...
        {
            await _nerkhCreateHandler.Handle(createDto,11, cancellationToken);
            return Ok(createDto);
        }
    }
}
