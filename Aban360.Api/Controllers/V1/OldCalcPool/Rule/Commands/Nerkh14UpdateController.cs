...
{
    [Route("v1/nerkh-14")]
    public class Nerkh14UpdateController : BaseController
    {
        private readonly INerkhUpdateHandler _nerkhUpdateHandler;
        public Nerkh14UpdateController(INerkhUpdateHandler nerkhUpdateHandler)
        {
        ...
        {
            await _nerkhUpdateHandler.Handle(UpdateDto, 14, cancellationToken);
            return Ok(UpdateDto);
        }
    }
}
