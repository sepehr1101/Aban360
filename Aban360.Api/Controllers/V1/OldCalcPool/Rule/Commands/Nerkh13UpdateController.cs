...
{
    [Route("v1/nerkh-13")]
    public class Nerkh13UpdateController : BaseController
    {
        private readonly INerkhUpdateHandler _nerkhUpdateHandler;
        public Nerkh13UpdateController(INerkhUpdateHandler nerkhUpdateHandler)
        {
        ...
        {
            await _nerkhUpdateHandler.Handle(UpdateDto, 13, cancellationToken);
            return Ok(UpdateDto);
        }
    }
}
