...
{
    [Route("v1/nerkh-11")]
    public class Nerkh11UpdateController : BaseController
    {
        private readonly INerkhUpdateHandler _nerkhUpdateHandler;
        public Nerkh11UpdateController(INerkhUpdateHandler nerkhUpdateHandler)
        {
        ...
        {
            await _nerkhUpdateHandler.Handle(UpdateDto, 11, cancellationToken);
            return Ok(UpdateDto);
        }
    }
}
