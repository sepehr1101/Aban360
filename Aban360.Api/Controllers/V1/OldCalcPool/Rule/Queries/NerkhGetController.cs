...
{
    [Route("v1/nerkh")]
    public class NerkhGetController : BaseController
    {
        private readonly INerkhGetHandler _nerkhGetHandler;
        public NerkhGetController(INerkhGetHandler nerkhGetHandler)
        {
        ...
        {
            NerkhGetDto result = await _nerkhGetHandler.Handle(id, cancellationToken);
            return Ok(result);
        }
    }
}
