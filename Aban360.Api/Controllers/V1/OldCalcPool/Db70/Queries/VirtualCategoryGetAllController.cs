...
namespace Aban360.Api.Controllers.V1.OldCalcPool.Db70.Queries
{
    ...
    public class VirtualCategoryGetAllController : BaseController
    {
        private readonly IVirtualCategoryGetAllHandler _virtualCategoryHandler;
        public VirtualCategoryGetAllController(IVirtualCategoryGetAllHandler virtualCategoryHandler)
        {
        ...
        {
            IEnumerable<VirtualCategoryGetDto> result = await _virtualCategoryHandler.Handle(cancellationToken);
            return Ok(result);
        }
    }
}
