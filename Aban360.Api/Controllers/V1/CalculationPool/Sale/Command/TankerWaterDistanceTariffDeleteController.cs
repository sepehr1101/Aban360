...
namespace Aban360.Api.Controllers.V1.CalculationPool.Sale.Command
{
    ...
    public class TankerWaterDistanceTariffDeleteController : BaseController
    {
        private readonly ITankerWaterDistanceTariffDeleteHadler _deleteHadler;
        public TankerWaterDistanceTariffDeleteController(ITankerWaterDistanceTariffDeleteHadler deleteHadler)
        {
