...
public partial class Aban360Context : DbContext
{
    ...
    public virtual DbSet<AssignAlgorithm> AssignAlgorithms { get; set; }
    ...
    public virtual DbSet<RequestEstate> RequestEstates { get; set; }
    ...
    public virtual DbSet<UsageLevel1> UsageLevel1s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("AccountType", "PaymentPool");
        ...
        modelBuilder.Entity<AssignAlgorithm>(entity =>
        {
            entity.ToTable("AssignAlgorithm", "WorkflowPool");
        ...
        {
            entity.ToTable("Bank", "PaymentPool");

            entity.Property(e => e.BankName).HasMaxLength(255);
            entity.Property(e => e.CentralBankCode).HasMaxLength(255);
        });

        modelBuilder.Entity<BankAccount>(entity =>
        {
            entity.ToTable("BankAccount", "PaymentPool");

            entity.Property(e => e.Iban)
                .HasMaxLength(24)
                .HasColumnName("IBan");
            entity.Property(e => e.Number).HasMaxLength(24);
            entity.Property(e => e.RegionTitle).HasMaxLength(255);
            entity.Property(e => e.Title).HasMaxLength(255);

            entity.HasOne(d => d.Bank).WithMany(p => p.BankAccounts)
                .HasForeignKey(d => d.BankId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Bank_REFERS_BankAccount_BankId");
        });

        modelBuilder.Entity<BankFileStructure>(entity =>
        {
            entity.ToTable("BankFileStructure", "PaymentPool");
        ...
        modelBuilder.Entity<ChangeMeterReason>(entity =>
        {
            entity.ToTable("ChangeMeterReason", "ClaimPool");
        ...
        {
            entity.ToTable("Credit", "PaymentPool");

            entity.Property(e => e.BillId).HasMaxLength(15);
            entity.Property(e => e.PaymentId).HasMaxLength(20);

            entity.HasOne(d => d.Uploader).WithMany(p => p.Credits)
                .HasForeignKey(d => d.UploaderId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Uploader_REFERS_Credit_UploaderId");
        });

        modelBuilder.Entity<CreditorType>(entity =>
        {
            entity.ToTable("CreditorType", "PaymentPool");
        ...
        {
            entity.ToTable("DiscountType", "ClaimPool");
        ...
        {
            entity.ToTable("Document", "BlobPool");

            entity.HasIndex(e => e.FileRowId, "UQ_Document_FileRowId").IsUnique();
            ...
            entity.Property(e => e.FileRowId).HasDefaultValueSql("(newid())");
            ...
            entity.HasOne(d => d.Parrent).WithMany(p => p.InverseParrent)
                ...
                .HasConstraintName("FK_Document_Parrent");
        });

        modelBuilder.Entity<DocumentCategory>(entity =>
        {
            entity.ToTable("DocumentCategory", "BlobPool");
        ...
        {
            entity.ToTable("DocumentEntity", "ClaimPool");
        });

        modelBuilder.Entity<DocumentType>(entity =>
        {
            entity.ToTable("DocumentType", "BlobPool");
            ...
            entity.HasOne(d => d.DocumentCategory).WithMany(p => p.DocumentTypes)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DocumentCategory_REFERS_DocumentType_DocumentCategoryId");
        });

        modelBuilder.Entity<DynamicReport>(entity =>
        {
            entity.ToTable("DynamicReport", "ReportPool");

            entity.Property(e => e.Name).HasMaxLength(255);
            entity.Property(e => e.ReportTemplateJson).IsUnicode(false);
        ...
        modelBuilder.Entity<EquipmentBroker>(entity =>
        {
            entity.ToTable("EquipmentBroker", "InstallationPool");

            entity.Property(e => e.ApiUrl).HasMaxLength(1023);
            entity.Property(e => e.Title).HasMaxLength(255);
            entity.Property(e => e.Website).HasMaxLength(1023);
        });

        modelBuilder.Entity<EquipmentBrokerZone>(entity =>
        {
            entity.ToTable("EquipmentBrokerZone", "InstallationPool");

            entity.Property(e => e.ZoneTitle).HasMaxLength(255);

            entity.HasOne(d => d.EquipmentBroker).WithMany(p => p.EquipmentBrokerZones)
                .HasForeignKey(d => d.EquipmentBrokerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EquipmentBroker_REFERS_EquipmentBrokerZone_EquipmentBrokerId");
        });
        ...
        modelBuilder.Entity<EstateWaterResource>(entity =>
        {
            entity.ToTable("EstateWaterResource", "ClaimPool");

            entity.HasOne(d => d.Estate).WithMany(p => p.EstateWaterResources)
                .HasForeignKey(d => d.EstateId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Estate_REFERS_EstateWaterResource_EstateId");

            entity.HasOne(d => d.WaterResource).WithMany(p => p.EstateWaterResources)
                .HasForeignKey(d => d.WaterResourceId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_WaterResource_REFERS_EstateWaterResource_WaterResourceId");
        });

        modelBuilder.Entity<ExecutableMimetype>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ExecutableMimetype", "BlobPool");
        ...
        {
            entity.ToTable("Gateway", "ClaimPool");
        ...
        {
            entity.ToTable("Handover", "ClaimPool");
        ...
        modelBuilder.Entity<IndividualDiscountType>(entity =>
        {
            entity.ToTable("IndividualDiscountType", "ClaimPool");

            entity.Property(e => e.RemoveLogInfo).HasMaxLength(255);

            entity.HasOne(d => d.DiscountType).WithMany(p => p.IndividualDiscountTypes)
                .HasForeignKey(d => d.DiscountTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DiscountType_REFERS_IndividualDiscountType_DiscountTypeId");

            entity.HasOne(d => d.Individual).WithMany(p => p.IndividualDiscountTypes)
                .HasForeignKey(d => d.IndividualId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Individual_REFERS_IndividualDiscountType_IndividualId");
        });
        ...
        modelBuilder.Entity<MimetypeCategory>(entity =>
        {
            entity.ToTable("MimetypeCategory", "BlobPool");
        ...
        {
            entity.ToTable("OfficialHoliday", "ClaimPool");

            entity.Property(e => e.DateJalali).HasMaxLength(10);
            entity.Property(e => e.Title).HasMaxLength(255);
        });
        ...
        {
            entity.ToTable("PaymentMethod", "PaymentPool");
        ...
        modelBuilder.Entity<RequestEstate>(entity =>
        {
            entity.ToTable("RequestEstate", "ClaimPool");
            ...
            entity.HasOne(d => d.ConstructionType).WithMany(p => p.RequestEstates)
                .HasForeignKey(d => d.ConstructionTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ConstructionType_REFERS_RequestEstate_ConstructionTypeId");

            entity.HasOne(d => d.EstateBoundType).WithMany(p => p.RequestEstates)
                .HasForeignKey(d => d.EstateBoundTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EstateBoundType_REFERS_RequestEstate_EstateBoundTypeId");

            entity.HasOne(d => d.Previous).WithMany(p => p.InversePrevious)
                .HasForeignKey(d => d.PreviousId)
                .HasConstraintName("FK_RequestEstate_REFERS_RequestEstate_PreviousId");

            entity.HasOne(d => d.UsageConsumtion).WithMany(p => p.RequestEstateUsageConsumtions)
                .HasForeignKey(d => d.UsageConsumtionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Usage_REFERS_RequestEstate_UsageId_Consumption");

            entity.HasOne(d => d.UsageSell).WithMany(p => p.RequestEstateUsageSells)
                .HasForeignKey(d => d.UsageSellId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Usage_REFERS_RequestEstate_UsageId_Sell");
        });

        modelBuilder.Entity<RequestFlat>(entity =>
        {
            entity.ToTable("RequestFlat", "ClaimPool");
            ...
            entity.HasOne(d => d.Estate).WithMany(p => p.RequestFlats)
                .HasForeignKey(d => d.EstateId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RequestEstate_REFERS_RequestFlat_RequestEstateId");
        });

        modelBuilder.Entity<RequestIndividual>(entity =>
        {
            entity.ToTable("RequestIndividual", "ClaimPool");
            ...
            entity.HasOne(d => d.IndividualType).WithMany(p => p.RequestIndividuals)
                .HasForeignKey(d => d.IndividualTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IndividualType_REFERS_RequestIndividual_IndividualTypeId");

            entity.HasOne(d => d.Previous).WithMany(p => p.InversePrevious)
                .HasForeignKey(d => d.PreviousId)
                .HasConstraintName("FK_RequestIndividual_REFERS_RequestIndividual_PreviousId");
        });

        modelBuilder.Entity<RequestIndividualDiscountType>(entity =>
        {
            entity.ToTable("RequestIndividualDiscountType", "ClaimPool");

            entity.Property(e => e.RemoveLogInfo).HasMaxLength(255);

            entity.HasOne(d => d.DiscountType).WithMany(p => p.RequestIndividualDiscountTypes)
                .HasForeignKey(d => d.DiscountTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DiscountType_REFERS_RequestIndividualDiscountType_DiscountTypeId");

            entity.HasOne(d => d.Individual).WithMany(p => p.RequestIndividualDiscountTypes)
                .HasForeignKey(d => d.IndividualId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RequestIndividual_REFERS_RequestIndividualDiscountType_RequestIndividualId");
        });

        modelBuilder.Entity<RequestIndividualEstate>(entity =>
        {
            entity.ToTable("RequestIndividualEstate", "ClaimPool");

            entity.HasOne(d => d.Estate).WithMany(p => p.RequestIndividualEstateEstates)
                .HasForeignKey(d => d.EstateId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RequestEstate_REFERS_RequestIndividualEstate_RequestEstateId");

            entity.HasOne(d => d.IndividualEstateRelationType).WithMany(p => p.RequestIndividualEstates)
                .HasForeignKey(d => d.IndividualEstateRelationTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IndividualEstateRelationType_REFERS_RequestIndividualEstate_IndividualEstateRelationTypeId");

            entity.HasOne(d => d.Individual).WithMany(p => p.RequestIndividualEstateIndividuals)
                .HasForeignKey(d => d.IndividualId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RequestIndividual_REFERS_RequestIndividualEstate_RequestIndividualId");
        });

        modelBuilder.Entity<RequestIndividualTag>(entity =>
        {
            entity.ToTable("RequestIndividualTag", "ClaimPool");

            entity.Property(e => e.RemoveLogInfo).HasMaxLength(255);
            entity.Property(e => e.Value).HasMaxLength(255);

            entity.HasOne(d => d.Individual).WithMany(p => p.RequestIndividualTags)
                .HasForeignKey(d => d.IndividualId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RequestIndividual_REFERS_RequestIndividualTag_RequestIndividualId");

            entity.HasOne(d => d.IndividualTagDefinition).WithMany(p => p.RequestIndividualTags)
                .HasForeignKey(d => d.IndividualTagDefinitionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IndividualTagDefinition_REFERS_RequestIndividualTag_IndividualTagDefinitionId");
        });

        modelBuilder.Entity<RequestSiphon>(entity =>
        {
            entity.ToTable("RequestSiphon", "ClaimPool");
            ...
            entity.HasOne(d => d.Previous).WithMany(p => p.InversePrevious)
                .HasForeignKey(d => d.PreviousId)
                .HasConstraintName("FK_RequestSiphon_REFERS_RequestSiphon_PreviousId");

            entity.HasOne(d => d.SiphonDiameter).WithMany(p => p.RequestSiphons)
                .HasForeignKey(d => d.SiphonDiameterId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SiphonDiameter_REFERS_RequestSiphon_SiphonDiameterId");

            entity.HasOne(d => d.SiphonMaterial).WithMany(p => p.RequestSiphons)
                .HasForeignKey(d => d.SiphonMaterialId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SiphonMaterial_REFERS_RequestSiphon_SiphonMaterialId");

            entity.HasOne(d => d.SiphonType).WithMany(p => p.RequestSiphons)
                .HasForeignKey(d => d.SiphonTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SiphonType_REFERS_RequestSiphon_SiphonTypeId");
        });

        modelBuilder.Entity<RequestWaterMeter>(entity =>
        {
            entity.ToTable("RequestWaterMeter", "ClaimPool");
            ...
            entity.HasOne(d => d.Estate).WithMany(p => p.RequestWaterMeters)
                .HasForeignKey(d => d.EstateId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RequestEstate_REFERS_RequestWaterMeter_RequestEstateId");

            entity.HasOne(d => d.MeterDiameter).WithMany(p => p.RequestWaterMeters)
                .HasForeignKey(d => d.MeterDiameterId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_MeterDiameter_REFERS_RequestWaterMeter_MeterDiameterId");

            entity.HasOne(d => d.MeterMaterial).WithMany(p => p.RequestWaterMeters)
                .HasForeignKey(d => d.MeterMaterialId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_MeterMaterial_REFERS_RequestWaterMeter_MeterMaterialId");

            entity.HasOne(d => d.MeterProducer).WithMany(p => p.RequestWaterMeters)
                .HasForeignKey(d => d.MeterProducerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_MeterProducer_REFERS_RequestWaterMeter_MeterProducerId");

            entity.HasOne(d => d.MeterType).WithMany(p => p.RequestWaterMeters)
                .HasForeignKey(d => d.MeterTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_MeterType_REFERS_RequestWaterMeter_MeterTypeId");

            entity.HasOne(d => d.MeterUseType).WithMany(p => p.RequestWaterMeters)
                .HasForeignKey(d => d.MeterUseTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_MeterUseType_REFERS_RequestWaterMeter_MeterUseTypeId");

            entity.HasOne(d => d.Parent).WithMany(p => p.InverseParent)
                .HasForeignKey(d => d.ParentId)
                .HasConstraintName("FK_WaterMeter_REFERS_RequestWaterMeter_WaterMeterId");

            entity.HasOne(d => d.Previous).WithMany(p => p.InversePrevious)
                .HasForeignKey(d => d.PreviousId)
                .HasConstraintName("FK_RequestWaterMeter_REFERS_RequestWaterMeter_PreviousId");

            entity.HasOne(d => d.SubscriptionType).WithMany(p => p.RequestWaterMeters)
                .HasForeignKey(d => d.SubscriptionTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SubscriptionType_REFERS_RequestWaterMeter_SubscriptionTypeId");

            entity.HasOne(d => d.UseState).WithMany(p => p.RequestWaterMeters)
                .HasForeignKey(d => d.UseStateId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UseState_REFERS_RequestWaterMeter_UseStateId");
        });

        modelBuilder.Entity<RequestWaterMeterSiphon>(entity =>
        {
            entity.ToTable("RequestWaterMeterSiphon", "ClaimPool");

            entity.HasOne(d => d.Siphon).WithMany(p => p.RequestWaterMeterSiphons)
                .HasForeignKey(d => d.SiphonId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RequestSiphon_REFERS_RequestWaterMeterSiphon_RequestSiphonId");

            entity.HasOne(d => d.WaterMeter).WithMany(p => p.RequestWaterMeterSiphons)
                .HasForeignKey(d => d.WaterMeterId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RequestWaterMeter_REFERS_RequestWaterMeterSiphon_RequestWaterMeterId");
        });

        modelBuilder.Entity<RequestWaterMeterTag>(entity =>
        {
            entity.ToTable("RequestWaterMeterTag", "ClaimPool");

            entity.Property(e => e.RemoveLogInfo).HasMaxLength(255);
            entity.Property(e => e.Value).HasMaxLength(255);

            entity.HasOne(d => d.WaterMeter).WithMany(p => p.RequestWaterMeterTags)
                .HasForeignKey(d => d.WaterMeterId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RequestWaterMeter_REFERS_RequestWaterMeterTag_RequestWaterMeterId");

            entity.HasOne(d => d.WaterMeterTagDefinition).WithMany(p => p.RequestWaterMeterTags)
                .HasForeignKey(d => d.WaterMeterTagDefinitionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_WaterMeterTagDefinition_REFERS_RequestWaterMeterTag_WaterMeterTagDefinitionId");
        });
        ...
        {
            entity.ToTable("State", "WorkflowPool");

            entity.Property(e => e.Title).HasMaxLength(255);
            entity.Property(e => e.ValidFrom).HasColumnType("datetime");
            entity.Property(e => e.ValidTo).HasColumnType("datetime");

            entity.HasOne(d => d.Workflow).WithMany(p => p.State1s)
                .HasForeignKey(d => d.WorkflowId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Workflow_REFERS_State_WorkflowId");
        });
        ...
        modelBuilder.Entity<SupportedField>(entity =>
        {
            entity.ToTable("SupportedField", "CalculationPool");

            entity.Property(e => e.Description).HasMaxLength(1023);
            entity.Property(e => e.Title).HasMaxLength(255);
        });

        modelBuilder.Entity<SupportedOperator>(entity =>
        {
            entity.ToTable("SupportedOperator", "CalculationPool");
        ...
        {
            entity.ToTable("Uploader", "PaymentPool");

            entity.Property(e => e.InsertDateTime).HasColumnType("datetime");
            entity.Property(e => e.Username).HasMaxLength(255);

            entity.HasOne(d => d.Bank).WithMany(p => p.Uploaders)
                .HasForeignKey(d => d.BankId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Bank_REFERS_Uploader_BankId");
        });
        ...
        modelBuilder.Entity<UsageLevel1>(entity =>
        {
            entity.ToTable("UsageLevel1", "ClaimPool");

            entity.Property(e => e.Id).ValueGeneratedNever();
            entity.Property(e => e.Title).HasMaxLength(255);
        });

        modelBuilder.Entity<UsageLevel2>(entity =>
        {
            entity.ToTable("UsageLevel2", "ClaimPool");

            entity.Property(e => e.Id).ValueGeneratedNever();
            entity.Property(e => e.Title).HasMaxLength(255);

            entity.HasOne(d => d.UsageLevel1).WithMany(p => p.UsageLevel2s)
                .HasForeignKey(d => d.UsageLevel1Id)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UsageLevel1_REFERS_UsageLevel2_UsageLevel1Id");
        });

        modelBuilder.Entity<UsageLevel3>(entity =>
        {
            entity.ToTable("UsageLevel3", "ClaimPool");

            entity.Property(e => e.Id).ValueGeneratedNever();
            entity.Property(e => e.Title).HasMaxLength(255);

            entity.HasOne(d => d.UsageLevel2).WithMany(p => p.UsageLevel3s)
                .HasForeignKey(d => d.UsageLevel2Id)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UsageLevel2_REFERS_UsageLevel3_UsageLevel2Id");
        });

        modelBuilder.Entity<UsageLevel4>(entity =>
        {
            entity.ToTable("UsageLevel4", "ClaimPool");

            entity.Property(e => e.Id).ValueGeneratedNever();
            entity.Property(e => e.Title).HasMaxLength(255);

            entity.HasOne(d => d.UsageLevel3).WithMany(p => p.UsageLevel4s)
                .HasForeignKey(d => d.UsageLevel3Id)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UsageLevel3_REFERS_UsageLevel4_UsageLevel3Id");
        });
        ...
        {
            entity.ToTable("UserLeave", "ClaimPool");

            entity.Property(e => e.FromDateJalali).HasMaxLength(10);
            entity.Property(e => e.RegiatereDatetime).HasColumnType("datetime");
            entity.Property(e => e.RegiatereFullname).HasMaxLength(255);
            entity.Property(e => e.ToDateJalali).HasMaxLength(10);
        ...
        {
            entity.ToTable("UserWorkday", "ClaimPool");
        ...
        modelBuilder.Entity<WaterMeterChangeNumberHistory>(entity =>
        {
            entity.ToTable("WaterMeterChangeNumberHistory", "CalculationPool");

            entity.HasOne(d => d.Invoice).WithMany(p => p.WaterMeterChangeNumberHistories)
                .HasForeignKey(d => d.InvoiceId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Invoice_REFERS_WaterMeterChangeNumberHistory_InvoiceId");
        });
        ...
        {
            entity.ToTable("WaterResource", "ClaimPool");
        ...
        {
            entity.ToTable("Workflow", "WorkflowPool");
            ...
            entity.HasOne(d => d.WorkflowStatus).WithMany(p => p.Workflows)
                .HasForeignKey(d => d.WorkflowStatusId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_WorkflowStatus_REFERS_Workflow_WorkflowStatusId");
        });

        modelBuilder.Entity<WorkflowStatus>(entity =>
        {
            entity.ToTable("WorkflowStatus", "WorkflowPool");
