...
using Aban360.LocationPool.GatewayAdhoc.Features.MainHeirarchy.Contracts;

namespace Aban360.LocationPool.GatewayAdhoc.Features.MainHeirarchy.Implementations
{
