USE [Aban360]
GO
INSERT [ClaimPool].[Estate] ( [ConstructionTypeId], EstateBoundTypeId,[HandoverId], [PostalCode], [X], [Y], [Parcel], [Address], [MunipulityId], [UsageSellId], [UsageConsumtionId], [UnitDomesticWater], [UnitCommercialWater], [UnitOtherWater], [UnitDomesticSewage], [UnitCommercialSewage], [UnitOtherSewage], [EmptyUnit], [HouseholdNumber], [Premises], [ImprovementsOverall], [ImprovementsDomestic], [ImprovementsCommercial], [ImprovementsOther], [ContractualCapacity], [Storeys], [UserId], [PreviousId],[CapacityCalculationIndexId], [ValidFrom], [ValidTo], [InsertLogInfo], [RemoveLogInfo], [Hash]) VALUES ( 1,1,1, N'1234567890', N'32.65', N'56.22', NULL, N'اصفهان آدرس آزمایشی', 11610002, 1, 1, 1, 1, 2, 1, 2, 1, 5, 2, 350, 250, 100, 20, 300, 2, 3, N'9eaaaa8c-4c95-4678-911c-048a035d877f', NULL,1, CAST(N'2025-02-23T13:22:38.2070000' AS DateTime2), NULL, N' ', NULL, N'')
GO
INSERT [ClaimPool].[Flat] ( [EstateId], [PostalCode], [Storey], [Description]) VALUES ( 1, N'1234567891', 2, N'جهت تست')
GO
INSERT [ClaimPool].[Individual] ( [IndividualTypeId], [FirstName],[surname], [NationalId], [FatherName], [PhoneNumbers], [MobileNumbers], [UserId], [PreviousId], [ValidFrom], [ValidTo], [InsertLogInfo], [RemoveLogInfo], [Hash]) VALUES ( 1, N'تست', N'تستیان پور', N'1234567890', N'ابوتست', N'0314567891', N'09135742557', N'9eaaaa8c-4c95-4678-911c-048a035d877f', NULL, CAST(N'2025-02-23T13:24:15.1670000' AS DateTime2), NULL, N'', NULL, N'')
GO
INSERT [ClaimPool].[IndividualEstate] ( [IndividualId], [EstateId], [IndividualEstateRelationTypeId]) VALUES ( 1, 1, 1)
GO
INSERT [ClaimPool].[IndividualEstate] ( [IndividualId], [EstateId], [IndividualEstateRelationTypeId]) VALUES (1, 1, 2)
GO
INSERT [ClaimPool].[IndividualEstate] ( [IndividualId], [EstateId], [IndividualEstateRelationTypeId]) VALUES (1, 1, 3)
GO
INSERT [ClaimPool].[IndividualEstate] ( [IndividualId], [EstateId], [IndividualEstateRelationTypeId]) VALUES (1, 1, 1)
GO
