...
{
    internal sealed class T7QueryService : AbstractBaseConnection, IT7QueryService
    {
        public T7QueryService(IConfiguration configuration)
            : base(configuration)
        {
        }
        ...
        public async Task<NumericDictionary> Get(int id, bool hasException)
        {
            ...
            {
                throw new InvalidDataException(ExceptionLiterals.InvalidBranchTypeTitle);
            }
