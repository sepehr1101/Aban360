    ...
    public class PaymentMethodeSeeder : IDataSeeder
    {
        ...
        public void SeedData()
        {
            ...
            ICollection<PaymentMethod> paymentMethods = new List<PaymentMethod>()
            {
                ...
                new PaymentMethod(){Id=PaymentMethodEnum.PresenceAtBank,Title="حضور در شعبه",Icon="pi pi-map-marker",Description="" },
                ...
                new PaymentMethod(){Id=PaymentMethodEnum.BankPhone,Title="تلفن بانک",Icon="pi pi-phone",Description="" },
                ...
                new PaymentMethod(){Id=PaymentMethodEnum.Internet,Title="اینترنت",Icon="pi pi-wifi",Description="" },
            };
