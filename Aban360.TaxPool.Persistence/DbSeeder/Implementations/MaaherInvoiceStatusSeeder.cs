...
{
    public class MaaherInvoiceStatusSeeder : AbstractBaseConnection, IDataSeeder
    {
        public int Order { get; set; } = 30;
        public MaaherInvoiceStatusSeeder(IConfiguration configuration)
            : base(configuration)
        {
        }
        ...
        private string GetSqlFilePath()
        {
            ...
            string relativePath = @"\DbSeeder\DataScript\MaaherInvoiceStatus.sql";
        ...
        private string GetQuery()
        {
            return @"Select COUNT(1)
                From [Aban360].TaxPool.MaaherInvoiceStatus";
        }
    }
}
