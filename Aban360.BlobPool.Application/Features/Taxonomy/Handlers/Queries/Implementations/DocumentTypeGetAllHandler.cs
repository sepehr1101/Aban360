...
{
    internal sealed class DocumentTypeGetAllHandler : IDocumentTypeGetAllHandler
    {
        private readonly IMapper _mapper;
        private readonly IDocumentTypeQueryService _documentTypeQueryService;
        public DocumentTypeGetAllHandler(
            IMapper mapper,
        ...
        public async Task<ICollection<DocumentTypeGetDto>> Handle(CancellationToken cancellationToken)
        {
            var documentType = await _documentTypeQueryService.Get();
            return _mapper.Map<ICollection<DocumentTypeGetDto>>(documentType);
        }
    }
}
